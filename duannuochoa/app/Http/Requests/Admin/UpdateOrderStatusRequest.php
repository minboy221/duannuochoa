...
class UpdateOrderStatusRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $allowedTransitions = [
            ...
            'Đang giao' => ['Đang giao', 'Đã giao hàng', 'Đã hoàn thành'],
            'Đã giao hàng' => ['Đã giao hàng', 'Đã hoàn thành', 'Trả hàng/Hoàn tiền'],
            'Đã hoàn thành' => ['Đã hoàn thành', 'Yêu cầu trả hàng'],
            'Đã hủy' => ['Đã hủy'],
            'Yêu cầu trả hàng' => ['Yêu cầu trả hàng', 'Trả hàng/Hoàn tiền', 'Đã hoàn thành'],
