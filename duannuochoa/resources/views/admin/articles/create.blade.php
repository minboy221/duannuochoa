    ...
    <main class="flex-1 p-8 ml-64 min-h-screen bg-slate-50">
        <div class="max-w-4xl mx-auto space-y-8">
            ...
            <div class="flex items-center gap-4 bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100">
                ...
                <div>
                    <h2 class="text-2xl font-black text-slate-800 tracking-tight font-headline">Viết bài mới</h2>
                    <p class="text-slate-500 font-medium text-xs">Phát hành nội dung mới lên trang tin tức</p>
                </div>
            </div>
                        ...
                        <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100">
                            ...
                            <div class="space-y-4">
                                <label class="flex items-center gap-3 p-3 rounded-xl bg-slate-50 cursor-pointer border border-transparent hover:border-blue-200 transition-all">
                                    <input type="radio" name="status" value="1" checked class="text-blue-600 focus:ring-blue-500">
                                    <div>
                                ...
                                <label class="flex items-center gap-3 p-3 rounded-xl bg-slate-50 cursor-pointer border border-transparent hover:border-blue-200 transition-all">
                                    <input type="radio" name="status" value="0" class="text-blue-600 focus:ring-blue-500">
                                    <div>
                        ...
                        <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="summary" rows="3"
                                          ...
                                          placeholder="Viết một đoạn ngắn giới thiệu bài viết...">{{ old('summary') }}</textarea>
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="content" rows="15" 
                                          ...
                                          placeholder="Bắt đầu viết nội dung tại đây...">{{ old('content') }}</textarea>
