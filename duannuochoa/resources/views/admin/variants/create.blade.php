        ...
        <form action="{{ route('admin.products.variants.store', $product) }}" method="POST" novalidate>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="text" name="price" value="{{ old('price', $product->base_price) != '' ? number_format((float)str_replace(',', '', old('price', $product->base_price))) : '' }}" class="currency-input w-full rounded-lg border-gray-300 p-3" required>
